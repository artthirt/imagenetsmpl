...
void ImNetSmplGpu::init()
{
    ...
    m_conv[0].init(ct::Size(W, H), 3, 2, 64, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, false, true);
    m_conv[1].init(m_conv[0].szOut(), 64, 2, 64, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[2].init(m_conv[1].szOut(), 64, 2, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[3].init(m_conv[2].szOut(), 128, 1, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[4].init(m_conv[3].szOut(), 128, 1, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[5].init(m_conv[4].szOut(), 128, 2, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[6].init(m_conv[5].szOut(), 256, 1, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[7].init(m_conv[6].szOut(), 256, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[8].init(m_conv[7].szOut(), 512, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[9].init(m_conv[8].szOut(), 512, 2, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
...
//	m_cnv_optim.setDelimiterIteration(16);
    ...
    m_mlp[0].setDropout(.92);
    m_mlp[1].setDropout(.92);
