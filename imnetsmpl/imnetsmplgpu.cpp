...
void ImNetSmplGpu::init()
{
    ...
    m_conv[3].init(m_conv[2].szOut(), 128, 2, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, false, true);
    m_conv[4].init(m_conv[3].szOut(), 128, 1, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, false, true);
    m_conv[5].init(m_conv[4].szOut(), 128, 1, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, false, true);
    m_conv[6].init(m_conv[5].szOut(), 256, 1, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, false, true);
    m_conv[7].init(m_conv[6].szOut(), 256, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, false, true);
