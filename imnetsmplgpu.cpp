...
void ImNetSmplGpu::init()
{
    ...
    m_conv[0].init(ct::Size(W, H), 3, 4, 128, ct::Size(7, 7), gpumat::LEAKYRELU, false, true, false, true);
    m_conv[1].init(m_conv[0].szOut(), 128, 2, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[2].init(m_conv[1].szOut(), 128, 2, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[3].init(m_conv[2].szOut(), 256, 1, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[4].init(m_conv[3].szOut(), 256, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[5].init(m_conv[4].szOut(), 512, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    ...
    m_conv[8].init(m_conv[7].szOut(), 512, 1, 768, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true);
