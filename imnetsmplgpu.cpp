...
void ImNetSmplGpu::init()
{
	...
	m_conv[2].init(m_conv[1].szOut(), 64, 1, 128, ct::Size(3, 3), gpumat::LEAKYRELU, true, true, true, true);
	...
	m_conv[7].init(m_conv[6].szOut(), 256, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, true, true, true, true);
...
//	m_cnv_optim.setDelimiterIteration(16);
    ...
    m_mlp[0].setDropout(.95);
    m_mlp[1].setDropout(.95);
