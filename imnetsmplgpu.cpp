...
void ImNetSmplGpu::init()
{
    ...
    m_conv[0].init(ct::Size(W, H), 3, 4, 128, ct::Size(7, 7), gpumat::LEAKYRELU, false, true, false);
    m_conv[1].init(m_conv[0].szOut(), 128, 2, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true);
