...
void ImNetSmplGpu::init()
{
    ...
    m_conv[6].init(m_conv[5].szOut(), 256, 1, 256, ct::Size(3, 3), gpumat::LEAKYRELU, true, true, true, true);
    m_conv[7].init(m_conv[6].szOut(), 256, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[8].init(m_conv[7].szOut(), 512, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, true, true, true, true);
