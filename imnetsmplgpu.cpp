...
void ImNetSmplGpu::init()
{
    ...
    m_conv[1].init(m_conv[0].szOut(), 32, 2, 64, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[2].init(m_conv[1].szOut(), 64, 1, 64, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[3].init(m_conv[2].szOut(), 64, 2, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[4].init(m_conv[3].szOut(), 128, 1, 128, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true, true);
    m_conv[5].init(m_conv[4].szOut(), 128, 2, 256, ct::Size(3, 3), gpumat::LEAKYRELU, false, true, true);
