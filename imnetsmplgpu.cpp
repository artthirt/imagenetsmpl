...
void ImNetSmplGpu::init()
{
	...
	m_conv[0].init(ct::Size(W, H), 3, 2, 32, ct::Size(5, 5), gpumat::LEAKYRELU, false, true, false);
	...
	m_conv[8].init(m_conv[7].szOut(), 256, 1, 512, ct::Size(3, 3), gpumat::LEAKYRELU, true, true, true);
...
//	m_cnv_optim.setDelimiterIteration(16);
	...
	m_mlp[1].setDropout(0.95);
	m_mlp[2].setDropout(0.95);
